function buildAdvice(data) {
  ...
  if (uvi <= 2) {
    return "Light clothing is fine. Sunglasses are recommended, and a hat can be used for comfort.";
  } else if (uvi <= 5) {
    return "Wear sunglasses and consider a hat. Light long-sleeve clothing is helpful during long outdoor exposure.";
  } else if (uvi <= 8) {
    return "Wear a wide-brim hat, sunglasses, and light long-sleeve clothing. Choose breathable fabrics to reduce sun exposure.";
  } else if (uvi <= 11) {
    return "Wear protective clothing such as long sleeves, a wide-brim hat, and UV-protective sunglasses. Cover as much skin as possible.";
  }
  return "Full sun-protective clothing recommended: long sleeves, long pants, wide-brim hat, sunglasses, and high-coverage fabrics.";
}
